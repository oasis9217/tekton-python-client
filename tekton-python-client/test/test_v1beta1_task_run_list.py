...
from tekton_pipeline.models.v1beta1_task_run_list import V1beta1TaskRunList  # noqa: E501
from tekton_pipeline.rest import ApiException

class TestV1beta1TaskRunList(unittest.TestCase):
    """V1beta1TaskRunList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1beta1TaskRunList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = tekton_pipeline.models.v1beta1_task_run_list.V1beta1TaskRunList()  # noqa: E501
        if include_optional :
            return V1beta1TaskRunList(
                api_version = '0', 
                items = [
                    tekton_pipeline.models.v1beta1/task_run.v1beta1.TaskRun(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 
    ...
    def testV1beta1TaskRunList(self):
        """Test V1beta1TaskRunList"""

...
from tekton_pipeline.models.v1_sidecar import V1Sidecar  # noqa: E501
from tekton_pipeline.rest import ApiException

class TestV1Sidecar(unittest.TestCase):
    """V1Sidecar unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = tekton_pipeline.models.v1_sidecar.V1Sidecar()  # noqa: E501
        if include_optional :
            return V1Sidecar(
                args = [
                    '0'

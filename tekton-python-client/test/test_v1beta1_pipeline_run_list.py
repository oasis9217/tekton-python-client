...
from tekton_pipeline.models.v1beta1_pipeline_run_list import V1beta1PipelineRunList  # noqa: E501
from tekton_pipeline.rest import ApiException

class TestV1beta1PipelineRunList(unittest.TestCase):
    """V1beta1PipelineRunList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1beta1PipelineRunList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = tekton_pipeline.models.v1beta1_pipeline_run_list.V1beta1PipelineRunList()  # noqa: E501
        if include_optional :
            return V1beta1PipelineRunList(
                api_version = '0', 
                items = [
                    tekton_pipeline.models.v1beta1/pipeline_run.v1beta1.PipelineRun(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 
                        spec = tekton_pipeline.models.v1beta1/pipeline_run_spec.v1beta1.PipelineRunSpec(
                            params = [
                        ...
                        status = tekton_pipeline.models.v1beta1/pipeline_run_status.v1beta1.PipelineRunStatus(

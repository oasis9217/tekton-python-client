...
from tekton_pipeline.models.v1_pipeline_list import V1PipelineList  # noqa: E501
from tekton_pipeline.rest import ApiException

class TestV1PipelineList(unittest.TestCase):
    """V1PipelineList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = tekton_pipeline.models.v1_pipeline_list.V1PipelineList()  # noqa: E501
        if include_optional :
            return V1PipelineList(
                api_version = '0', 
                items = [
                    tekton_pipeline.models.v1/pipeline.v1.Pipeline(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 

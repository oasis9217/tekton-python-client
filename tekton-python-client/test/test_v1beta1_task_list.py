...
from tekton_pipeline.models.v1beta1_task_list import V1beta1TaskList  # noqa: E501
...
class TestV1beta1TaskList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tekton_pipeline.models.v1beta1_task_list.V1beta1TaskList()  # noqa: E501
        if include_optional :
            return V1beta1TaskList(
                api_version = '0', 
                items = [
                    tekton_pipeline.models.v1beta1/task.v1beta1.Task(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 

...
from tekton_pipeline.models.v1beta1_task_resource_binding import V1beta1TaskResourceBinding  # noqa: E501
...
class TestV1beta1TaskResourceBinding(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tekton_pipeline.models.v1beta1_task_resource_binding.V1beta1TaskResourceBinding()  # noqa: E501
        if include_optional :
            return V1beta1TaskResourceBinding(
                name = '0', 
                paths = [
                    '0'
                    ], 

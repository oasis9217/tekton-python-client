...
from tekton_pipeline.models.v1beta1_pipeline_list import V1beta1PipelineList  # noqa: E501
from tekton_pipeline.rest import ApiException

class TestV1beta1PipelineList(unittest.TestCase):
    """V1beta1PipelineList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1beta1PipelineList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = tekton_pipeline.models.v1beta1_pipeline_list.V1beta1PipelineList()  # noqa: E501
        if include_optional :
            return V1beta1PipelineList(
                api_version = '0', 
                items = [
                    tekton_pipeline.models.v1beta1/pipeline.v1beta1.Pipeline(
                        api_version = '0', 
                        kind = '0', 
                        metadata = None, 
                        spec = tekton_pipeline.models.v1beta1/pipeline_spec.v1beta1.PipelineSpec(
                            description = '0', 
                            finally = [
    ...
    def testV1beta1PipelineList(self):
        """Test V1beta1PipelineList"""

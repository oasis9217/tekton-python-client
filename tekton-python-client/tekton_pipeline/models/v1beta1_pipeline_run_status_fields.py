...
class V1beta1PipelineRunStatusFields(object):
    ...
    def __init__(self, completion_time=None, pipeline_results=None, pipeline_spec=None, runs=None, skipped_tasks=None, start_time=None, task_runs=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def runs(self):
        """Gets the runs of this V1beta1PipelineRunStatusFields.  # noqa: E501

        map of PipelineRunRunStatus with the run name as the key  # noqa: E501

        :return: The runs of this V1beta1PipelineRunStatusFields.  # noqa: E501
    ...
    @runs.setter
    def runs(self, runs):
        """Sets the runs of this V1beta1PipelineRunStatusFields.

        map of PipelineRunRunStatus with the run name as the key  # noqa: E501

        :param runs: The runs of this V1beta1PipelineRunStatusFields.  # noqa: E501
